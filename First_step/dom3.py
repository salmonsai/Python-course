...
if currency_convertor:
    ...
    target_currency = input("Input target currency: ")
    target_currency_amount = int(input("Input amount of money in USD: "))
    currency_result = 0
else:
    print('Переменная currency_convertor = ', item_3)
# 31.4 Сделать if в котором будет условие: если target_currency равен ‘eur’, то в теле этого if в значении переменной currency_result высчитать сколько долларов получится при target_currency_amount и usd_eur_rate.
...
# 31.5 Сделать elif в котором будет условие: если target_currency равен ‘uah’, то в теле этого if в значении переменной currency_result высчитать сколько долларов получится при target_currency_amount и usd_uah_rate.
...
# 31.6 Сделать elif с остальными валютами
    ...
    print(target_currency, chf_item, '=', currency_result, chf_item)
...
# 31.7 Последним оставить else, при выполнений которbого в консоль выведется (“Unknow currency”)